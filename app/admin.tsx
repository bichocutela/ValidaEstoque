...
import { ALERT_LEAD_DAY_OPTIONS, type AlertLeadDays } from "@/lib/inventory-data";
...
const eventLabels: Record<string, string> = { login: "Entrou no aplicativo", logout: "Encerrou a sessão", signup: "Criou o cadastro", product_created: "Cadastrou produto", lot_created: "Registrou lote", movement_created: "Registrou movimentação" };
...
export default function AdminScreen() {
  ...
  const { employeeRole, alertLeadDays, updateStoreAlertLeadDays } = useInventory();
...
const styles = StyleSheet.create({ content: { paddingTop: 14, paddingBottom: 34 }, header: { flexDirection: "row", gap: 12, alignItems: "center" }, back: { width: 42, height: 42, borderRadius: 14, backgroundColor: "#EAF5F0", alignItems: "center", justifyContent: "center" }, title: { color: "#18211F", fontSize: 25, fontWeight: "900" }, subtitle: { color: "#60706C", fontSize: 12, marginTop: 3 }, summary: { flexDirection: "row", gap: 9, marginTop: 21 }, summaryItem: { flex: 1, minHeight: 100, padding: 12, borderRadius: 18, backgroundColor: "#EAF5F0", justifyContent: "space-between" }, summaryValue: { color: "#18211F", fontSize: 23, fontWeight: "900", marginTop: 4 }, summaryLabel: { color: "#4D645E", fontSize: 11, fontWeight: "700" }, sectionTitle: { color: "#18211F", fontSize: 16, fontWeight: "900", marginTop: 25, marginBottom: 10 }, alertCard: { padding: 14, borderRadius: 19, borderWidth: 1, borderColor: "#D9EAE4", backgroundColor: "#FFFFFF" }, alertHeading: { flexDirection: "row", alignItems: "flex-start", gap: 10 }, alertIcon: { width: 38, height: 38, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "#EAF5F0" }, alertText: { flex: 1 }, alertTitle: { color: "#18211F", fontSize: 14, fontWeight: "900" }, alertDescription: { color: "#60706C", fontSize: 11, lineHeight: 15, marginTop: 2 }, dayChoices: { marginTop: 14, flexDirection: "row", flexWrap: "wrap", gap: 8 }, dayChoice: { width: "30.7%", minHeight: 62, borderRadius: 14, borderWidth: 1, borderColor: "#DFE8E4", backgroundColor: "#FAFCFB", alignItems: "center", justifyContent: "center" }, dayChoiceActive: { backgroundColor: "#0B5D52", borderColor: "#0B5D52" }, dayNumber: { color: "#18211F", fontSize: 17, lineHeight: 20, fontWeight: "900" }, dayNumberActive: { color: "#FFFFFF" }, dayLabel: { color: "#60706C", fontSize: 10, fontWeight: "800" }, dayLabelActive: { color: "#D4F2E9" }, criticalNote: { marginTop: 13, padding: 11, borderRadius: 13, flexDirection: "row", gap: 8, alignItems: "flex-start", backgroundColor: "#FFF0E6" }, criticalText: { flex: 1, color: "#815129", fontSize: 11, lineHeight: 15 }, criticalStrong: { color: "#9E4205", fontWeight: "900" }, staffList: { gap: 9 }, staffCard: { padding: 12, borderWidth: 1, borderColor: "#E5ECE9", borderRadius: 17, backgroundColor: "#FFFFFF", flexDirection: "row", alignItems: "center", gap: 10 }, initials: { width: 39, height: 39, borderRadius: 13, backgroundColor: "#DDF1EA", alignItems: "center", justifyContent: "center" }, initialsText: { color: "#0B5D52", fontWeight: "900", fontSize: 12 }, staffText: { flex: 1 }, staffName: { color: "#18211F", fontSize: 14, fontWeight: "900" }, staffMeta: { color: "#60706C", fontSize: 10, marginTop: 3 }, statusButton: { paddingHorizontal: 9, paddingVertical: 7, borderRadius: 10, backgroundColor: "#FDEBEB" }, statusSuspended: { backgroundColor: "#EAF5F0" }, statusText: { color: "#A72F2F", fontSize: 10, fontWeight: "900" }, adminTag: { paddingHorizontal: 8, paddingVertical: 5, backgroundColor: "#DDF1EA", borderRadius: 8 }, adminTagText: { color: "#0B5D52", fontSize: 10, fontWeight: "900" }, eventCard: { flexDirection: "row", gap: 11, padding: 13, marginBottom: 8, borderRadius: 16, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E5ECE9" }, eventIcon: { width: 34, height: 34, borderRadius: 11, backgroundColor: "#EAF5F0", alignItems: "center", justifyContent: "center" }, eventText: { flex: 1 }, eventTitle: { color: "#18211F", fontSize: 13, fontWeight: "800" }, eventMeta: { color: "#60706C", fontSize: 11, marginTop: 4 }, empty: { color: "#60706C", textAlign: "center", paddingVertical: 18 }, pressed: { opacity: 0.72, transform: [{ scale: 0.98 }] } });
