...
export default function ScannerScreen() {
  ...
  const scan = ({ data }: BarcodeScanningResult) => {
    ...
    showScanSuccess(() => { setCameraOpen(false); Alert.alert("Código lido", `${productText}${lotText}${expiryText}`); });
  };
